...
/**
 * Esta clase es una ventana de Java Swing que sirve para hacer animaciones de vectores o matrices y contiene métodos para facilitar eso
 * 
...
public class Ventana extends JFrame {
	...
	/**
	 * Esta variable, mejor conocida como constante, define el tiempo de espera de la simulación. Representa una cantidad de milisegundos
	 */
	private static final int ESPERA = 300;

	/**
	 * Esta matriz contiene los botones que se despliegan en el panel durante la animación
	 */
	private JPanel panel[][];
	private JLabel label[][];

	/**
	 * Este constructor permite crear una ventana que despliega un vector de enteros
	 * 
	 * @param v
	...
	/**
	 * Este constructor permite crear una ventana que despliega un vector de doubles
	 * 
	 * @param v
	...
	/**
	 * Este constructor permite crear una ventana que despliega cualquier vector de objetos
	 * 
	 * @param v
	...
	public Ventana(int m[][]) {
		this.init(m.length, m[0].length);
		this.visualizarMatriz(m);
	}

	/**
	 * Este método crea una ventana de f x c e inicializa el atributo de botones
	 * 
	 * La ventana creada tiene botones sin texto y con blanco como color de fondo
	 * 
	 * @param f
	 ...
	 * 
	 * @param v
	 *            Vector de enteros a visualizar
	 */
	 ...
	 * 
	 * @param v
	 *            Vector de doubles a visualizar
	 */
	 ...
	 * 
	 * @param v
	 *            Vector de objetos a visualizar
	 */
	 ...
	 *            Columna
	 * @param text
	 *            Texto a escribir en la posición i, j
	 */
	 ...
	 *            Columna
	 * @param c
	 *            Color a utilizar para resaltar
	 */
